...
function saveImage() {
    ...
    // 合成したCanvasから画像データを取得
    var mergedImage = mergedCanvas.toDataURL("image/png").replace("image/png", "image/octet-stream");

    // リンクのhrefに画像データをセットし、クリックイベントをトリガーしてダウンロードさせる
